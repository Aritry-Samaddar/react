...
export const signin=createAsyncThunk('/FinalProject/signin',async (obj)=>{
    try{
...
export const getProducts=createAsyncThunk('/FinalProject/getProducts',async ()=>{
    try{
...
export const createProducts=createAsyncThunk('/FinalProject/createProducts',async (data)=>{
    try{
...
export const deleteProducts=createAsyncThunk('/FinalProject/deleteProducts',async (itemid)=>{
    try{
...
export const updateProducts=createAsyncThunk('/FinalProject/updateProducts',async (data)=>{
    try{
...
export const getUsers=createAsyncThunk('/FinalProject/getUsers',async ()=>{
    try{
...
export const deleteUsers=createAsyncThunk('/FinalProject/deleteUsers',async (itemid)=>{
    try{
...
export const updateUsers=createAsyncThunk('/FinalProject/updateUsers',async (data)=>{
    try{
...
export const createUsers=createAsyncThunk('/FinalProject/createUsers',async (data)=>{
    try{
...
export const updateCoupon=createAsyncThunk('/FinalProject/updateCoupon',async (data)=>{
    try{
...
export const getSalesReport=createAsyncThunk('/FinalProject/getSalesReport',async ()=>{
    try{
...
export const deleteSales=createAsyncThunk('/FinalProject/deleteSales',async (itemid)=>{
    try{
...
export const signoutUsers=createAsyncThunk('/FinalProject/signoutUsers',async ()=>{
    try{
...
export const updateProfile=createAsyncThunk('/FinalProject/updateProfile',async (data)=>{
    try{
